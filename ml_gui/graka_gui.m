...
% Last Modified by GUIDE v2.5 05-Sep-2012 21:18:57
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
handles.ser = serial(handles.com_port, 'BAUD', str2double(get(handles.com_baud, 'String')));
open_ser_port(handles);
if(strcmp(get(handles.ser, 'Status'),'open'))
    set(handles.com_status,'String', 'COM port opened');
...
ports = cellstr(get(hObject,'String'));
handles.com_port = ports(get(hObject,'Value'));
guidata(hObject, handles);
